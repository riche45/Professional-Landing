export default {
  ...
  chat: {
    welcome: '¡Hola! Soy Richard García, desarrollador de software con más de 5 años de experiencia. Puedo contarte sobre mis proyectos, experiencia profesional, artículos técnicos y colaboraciones. ¿En qué puedo ayudarte?',
    assistant_status: 'Asistente Virtual • Siempre disponible',
    input_placeholder: 'Pregúntame sobre mi experiencia, proyectos o tecnologías...',
    enter_hint: 'Presiona Enter para enviar, Shift + Enter para nueva línea',
