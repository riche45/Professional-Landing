import { Github, Linkedin, Mail, Globe, BookOpen, ExternalLink, Calendar, Link2 } from 'lucide-react';
  ...
  const linksData = [
    {
      ...
      links: [
        ...
        {
          icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4l11.733 16h4.267l-11.733 -16z"/><path d="M4 20l6.768 -6.768m2.46 -2.46L20 4"/></svg>, name: 'X', url: 'https://x.com/codeand0', desc: t('links.social.twitter')
        },
        {
